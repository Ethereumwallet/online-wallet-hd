...
module.exports = {
    ...
    getURL: function() {
        ...
        browser.driver.get('https://dev.ethereumwallet.org/#/login'); // Dev server
        //browser.driver.get('https://staging.ethereumwallet.org/#/login'); // Staging server
        //browser.driver.get('https://alpha.ethereumwallet.org/#/login'); // Alpha server
        //browser.driver.get('http://local.ethereumwallet.org:8080/#/login'); // Localhost
    ...
    submitBetaKey: function () {
        ...
        promise.then(function(currentURL) {
            ...
            if (currentURL == 'http://local.ethereumwallet.org:8080/#/login') {
                console.log('URL is local.ethereumwallet.org:8080');
            ...
            else if (currentURL == 'https://dev.ethereumwallet.org/#/login') {
                console.log('URL is dev.ethereumwallet.org');
            ...
            else if (currentURL == 'https://alpha.ethereumwallet.org/#/login') {
                console.log('URL is dev.ethereumwallet.org');
