 ...
 * Version: 0.12.0 - 2015-07-09T11:42:45.195Z
 * License: MIT
 */
...
uis.controller('uiSelectCtrl',
  ...
  function _resetSearchInput(force) {
    if (force | ctrl.resetSearchInput || (ctrl.resetSearchInput === undefined && uiSelectConfig.resetSearchInput)) {
      ctrl.search = EMPTY_SEARCH;
      //reset activeIndex
  ...
  return {
    ...
    compile: function(tElement, tAttrs) {
      ...
      return function(scope, element, attrs, ctrls, transcludeFn) {
        ...
        //Reset form based on scope event name (e.g. reset-search-input-on='SomeEventName')
        if (angular.isDefined(attrs.resetSearchInputOn)){
